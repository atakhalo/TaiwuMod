...
namespace AaTemplate
{
    [PluginConfig(pluginName: "AaTemplate", creatorId: "atakhalo", pluginVersion: "0.1.0.1")]
    public class AaTemplateFrontendPlugin : TaiwuRemakePlugin
    {
        ...
        {
			MyUtils.modName = nameof(AaTemplate);
			MyUtils.MyLog($"Initialize");
            harmony = Harmony.CreateAndPatchAll(typeof(AaTemplateFrontendPlugin));
        }
